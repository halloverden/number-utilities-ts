...
describe('getLuhnControlDigit()', () => {
  ...
  it('should validate the last control digit', () => {
    expect.hasAssertions();
    const values = [
...
describe('getLuhnControlDigits()', () => {
  it('should return an array of correct control digits', () => {
    expect.hasAssertions();
    const values = [
  ...
  it('should validate the given number of control digits', () => {
    expect.hasAssertions();
    const values = [
