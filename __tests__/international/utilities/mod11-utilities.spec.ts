...
test( 'getLuhnControlDigit() should create correct control digit', () => {
  const values = [
  ...
  values.forEach( ( v ) => {
    const output = getMod11ControlDigit( v.input );
    expect( output ).toEqual( v.expectedOutput );
  } );

} );

test( 'getLuhnControlDigits() should return an array of correct control digits', () => {
  const values = [
  ...
  values.forEach( ( v ) => {
    const output = getMod11ControlDigits( v.input, v.numberOfDigits );
    expect( output ).toEqual( v.expectedOutput );
  } );

} );

test( 'checkLuhnControlDigit() should validate the last control digit', () => {
  const values = [
  ...
  values.forEach( ( v ) => {
    const output = checkMod11ControlDigit( v.input );
    expect( output ).toEqual( v.expectedOutput );
  } );

} );

test( 'checkLuhnControlDigits() should validate the given number of control digits', () => {
  const values = [
  ...
  values.forEach( ( v ) => {
    const output = checkMod11ControlDigits( v.input, v.numberOfDigits );
    expect( output ).toEqual( v.expectedOutput );
  } );
